...
export default function Navbar(props) {
  ...
  <div className="container-fluid" >
    <a className="navbar-brand" style={{color : props.mode === 'Dark'?'white':'black'}} href="/"> <img src={image1}  width="30" height="24"  ></img> {props.title}
    </a>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <a className="nav-link" href="/" style={{color : props.mode === 'Dark'?'white':'black'}}>{props.About}
          </a>
        </li>
        </ul>
